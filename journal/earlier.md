...
| [Week 4: Pivot tables, pivot charts, slicers, and a one-page man](#week-4-pivot-tables-pivot-charts-slicers-and-a-one-page-man) | 1 | 0 | 21 Jul 2026, 19:30 |
...
| Phase | Excel |
| Saved/updated | 21 Jul 2026, 19:30 |
| Completed tasks | 2 |
...
- **Built:** I created a weekly series Excel workbook `week-04-hotel-report.xlsx` to keep BookingRawData, PivotAnalysis and Notes worksheets to keep data organised in one Excel File
