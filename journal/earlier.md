...
| [Week 3: Cleaning data: duplicates, TRIM/PROPER, text-to-columns](#week-3-cleaning-data-duplicates-trimproper-text-to-columns) | 4 | 3 | 19 Jul 2026, 19:18 |
...
| Phase | Excel |
| Saved/updated | 19 Jul 2026, 19:18 |
| Completed tasks | 5 |
...
- **Applied:** I applied the Excel SUM formula to calculate the total Billed ` =SUM(Billed)` which returned £32,630,000 to answer the business question
