...
| Review: Normal distribution, z-scores, probability, and the 68-95-99.7 rule | In progress | 0 | 22 Aug 2026, 20:57 |
...
- **Why it matters:** A sample size of 8 is too small to confirm normality because test lacks statistical power making it impossible to detect skewness
- **Built:** I wrote this formula in Excel `=NORM.DIST(95,100,3,TRUE) `A factory has 5% defect rate. Mean = 100g, SD = 3g, reject threshold = 95g. to confirm this matches NORM.DIST
